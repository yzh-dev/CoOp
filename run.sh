...
#EnCoOp
python3 train.py --resume 0 --root ../../data --trainer  CoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  real_world --target-domains product --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  real_world --target-domains product --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  real_world --target-domains product --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  real_world --target-domains product --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  CoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  product --target-domains real_world --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  product --target-domains real_world --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  product --target-domains real_world --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains art clipart  product --target-domains real_world --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  CoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains clipart  product real_world --target-domains art --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains clipart  product real_world --target-domains art --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains clipart  product real_world --target-domains art --output-dir output/EnCoOp/exp1
#python3 train.py --resume 0 --root ../../data --trainer  EnCoOp --dataset-config-file configs/datasets/officehome.yaml --config-file configs/trainers/EnCoOp/rn50_ep50_ctxv1.yaml --source-domains clipart  product real_world --target-domains art --output-dir output/EnCoOp/exp1
